...
function Home() {
  ...
  const cards = [
    ...
    },
    {
      ...
      title: 'Формировать документы и отчёты',
      text: 'Владельцы могут формировать регистрационные документы, а сотрудники — экспортировать отчёты по зарегистрированным ТС.'
    }
  ];
